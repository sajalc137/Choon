...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INTEGER_LITERAL = 26,           /* INTEGER_LITERAL  */
  YYSYMBOL_CHARACTER_LITERAL = 27,         /* CHARACTER_LITERAL  */
  YYSYMBOL_FLOAT_LITERAL = 28,             /* FLOAT_LITERAL  */
  ...
  YYSYMBOL_MUL_ASSIGN = 38,                /* MUL_ASSIGN  */
  ...
  YYSYMBOL_59_ = 59,                       /* '!'  */
  YYSYMBOL_60_ = 60,                       /* '~'  */
  YYSYMBOL_61_INC_OP_ = 61,                /* "INC_OP"  */
  YYSYMBOL_62_DEC_OP_ = 62,                /* "DEC_OP"  */
  YYSYMBOL_YYACCEPT = 63,                  /* $accept  */
  YYSYMBOL_S = 64,                         /* S  */
  YYSYMBOL_program = 65,                   /* program  */
  YYSYMBOL_NSPACE = 66,                    /* NSPACE  */
  YYSYMBOL_translation_unit = 67,          /* translation_unit  */
  YYSYMBOL_ext_dec = 68,                   /* ext_dec  */
  YYSYMBOL_libraries = 69,                 /* libraries  */
  ...
  YYSYMBOL_printstat = 73,                 /* printstat  */
  YYSYMBOL_declaration = 74,               /* declaration  */
  YYSYMBOL_statement = 75,                 /* statement  */
  YYSYMBOL_conditional_statement = 76,     /* conditional_statement  */
  YYSYMBOL_77_1 = 77,                      /* $@1  */
  YYSYMBOL_78_2 = 78,                      /* $@2  */
  ...
  YYSYMBOL_init_declarator_list = 86,      /* init_declarator_list  */
  YYSYMBOL_init_declarator = 87,           /* init_declarator  */
...
static const yytype_int16 yyrline[] =
{
     ...
     529,   530,   535,   536,   541,   555,   560,   561,   647,   648,
     649,   650,   651,   652,   657,   659,   666,   658,   695,   696,
     701,   702,   707,   708,   709,   710,   711,   716,   717,   729,
     744,   745,   781,   782,   783,   784,   785,   786,   791,   792,
     802,   816,   817,   827,   837,   847,   861,   862,   873,   887,
     888,   898,   908,   922,   923,   927,   935,   944,   950,   954,
     955,   960,   961,   966,   967,   972,   977
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CSTDIO", "STDLIB", "MATH", "STRING", "TIME", "IOSTREAM", "CONIO",
  "NAMESPACE", "COUT", "ENDL", "STRING_LITERAL", "HEADER_LITERAL", "PRINT",
  "RETURN", "'+'", "'-'", "'/'", "'*'", "'%'", "'='", "UMINUS",
  "INTEGER_LITERAL", "CHARACTER_LITERAL", "FLOAT_LITERAL", "IDENTIFIER",
  "FOR", "WHILE", "INC_OP", "DEC_OP", "LE_OP", "GE_OP", "EQ_OP", "NE_OP",
  "MUL_ASSIGN", "DIV_ASSIGN", "MOD_ASSIGN", "ADD_ASSIGN", "SUB_ASSIGN",
  "CHAR", "INT", "FLOAT", "VOID", "IF", "ELSE", "'<'", "'>'", "';'", "'{'",
  "'}'", "'('", "')'", "','", "'?'", "':'", "'!'", "'~'", "\"INC_OP\"",
  "\"DEC_OP\"", "$accept", "S", "program", "NSPACE", "translation_unit",
  ...
  "$@4", "$@5", "$@6", "expr", "type_specifier", "init_declarator_list",
  "init_declarator", "assignment_expression", "assignment_operator",
  "conditional_expression", "$@7", "$@8", "expression_statement",
...
#line 1518 "y.tab.c"
  ...
  case 38: /* conditional_statement: ELSE statement  */
#line 172 "icg.y"
          {
		  	fprintf(fp_icg, "L%d:\n", ln);
			fprintf(fp_quad, "\tLabel\t\t  \t\t  \t\tL%d\n", ln);
...
#line 1548 "y.tab.c"
  ...
  case 42: /* iteration_statement: FOR '(' expression_statement $@3 expression_statement $@4 expr ')' statement  */
#line 194 "icg.y"
                {
...
#line 1724 "y.tab.c"
  ...
  case 45: /* iteration_statement: WHILE '(' $@5 conditional_expression ')' $@6 statement  */
#line 358 "icg.y"
                        {
			fprintf(fp_icg, "goto L%d\n", --ln);
			fprintf(fp_quad, "\tgoto\t\t  \t\t  \t\tL%d\n", ln);
...
#line 1739 "y.tab.c"
  ...
  case 46: /* expr: IDENTIFIER INC_OP  */
#line 379 "icg.y"
                {  
			// printf("ID %s\n", $1);
			exprno = 0; 
...
#line 1752 "y.tab.c"
  ...
  case 47: /* expr: IDENTIFIER DEC_OP  */
#line 388 "icg.y"
                {  
			exprno = 1;
...
#line 1764 "y.tab.c"
  ...
  case 48: /* expr: INC_OP IDENTIFIER  */
#line 396 "icg.y"
                {  
			exprno = 2;
...
#line 1776 "y.tab.c"
  ...
  case 49: /* expr: DEC_OP IDENTIFIER  */
#line 404 "icg.y"
                {  
			exprno = 3; 
...
#line 1788 "y.tab.c"
  ...
  case 50: /* expr: IDENTIFIER ADD_ASSIGN INTEGER_LITERAL  */
#line 412 "icg.y"
                {  
			exprno = 4; 
...
#line 1805 "y.tab.c"
  ...
  case 51: /* expr: IDENTIFIER SUB_ASSIGN INTEGER_LITERAL  */
#line 425 "icg.y"
                {  
			exprno = 5;
...
#line 1821 "y.tab.c"
  ...
  case 52: /* expr: IDENTIFIER MUL_ASSIGN INTEGER_LITERAL  */
#line 437 "icg.y"
                {  
			exprno = 6;
...
#line 1837 "y.tab.c"
  ...
  case 53: /* expr: IDENTIFIER DIV_ASSIGN INTEGER_LITERAL  */
#line 449 "icg.y"
                {  
			exprno = 7; 
...
#line 1853 "y.tab.c"
  ...
  case 54: /* expr: IDENTIFIER '=' IDENTIFIER '+' INTEGER_LITERAL  */
#line 461 "icg.y"
                {  
			exprno = 8;
...
#line 1873 "y.tab.c"
  ...
  case 55: /* expr: IDENTIFIER '=' IDENTIFIER '-' INTEGER_LITERAL  */
#line 477 "icg.y"
                {  
			exprno = 9;
...
#line 1893 "y.tab.c"
  ...
  case 56: /* expr: IDENTIFIER '=' IDENTIFIER '*' INTEGER_LITERAL  */
#line 493 "icg.y"
                {  
			exprno = 10; 
...
#line 1913 "y.tab.c"
  ...
  case 57: /* expr: IDENTIFIER '=' IDENTIFIER '/' INTEGER_LITERAL  */
#line 509 "icg.y"
                {  
			exprno = 11; 
...
#line 1933 "y.tab.c"
  ...
  case 64: /* init_declarator: IDENTIFIER '=' assignment_expression  */
#line 542 "icg.y"
                {
			if(tempno > 0){
...
#line 562 "icg.y"
			...
			switch(assignop){
				case 0: 
						...
						fprintf(fp_choon, ". %s =%s ", (yyvsp[-2].sval), (yyvsp[0].sval));
						break;
				...
				case 1: 
						...
						// fprintf(fp_quad, "\t=\t\tt%d\t\t  \t\t%s\n", tempno, $1);
						// tempno++;
						fprintf(fp_choon, ". =%s+ %s =%s ", (yyvsp[0].sval), (yyvsp[-2].sval), (yyvsp[-2].sval));
						break;
				case 2:
						// sprintf(buffer,"t%d",tempno++);
						// m = strlen(buffer);
				...
				case 3:
						...
						// fprintf(fp_quad, "\t=\t\tt%d\t\t  \t\t%s\n", tempno, $1);
						// tempno++;
						fprintf(fp_choon, ". 1- =%s ||: . =%s+ %s =%s :|| ", (yyvsp[0].sval), (yyvsp[-2].sval), (yyvsp[-2].sval), (yyvsp[-2].sval));
						break;
				case 4:
						sprintf(buffer,"t%d",tempno++);
						m = strlen(buffer);
...
#line 2079 "y.tab.c"
  ...
  case 74: /* conditional_expression: equality_expression  */
#line 657 "icg.y"
                                {	strcpy((yyval.sval), (yyvsp[0].sval));  }
#line 2085 "y.tab.c"
    break;
...
#line 2115 "y.tab.c"
  ...
  case 77: /* conditional_expression: equality_expression $@7 '?' expression $@8 ':' conditional_expression  */
#line 681 "icg.y"
                {
...
#line 2135 "y.tab.c"
  ...
  case 82: /* primary_expression: IDENTIFIER  */
#line 707 "icg.y"
                                        {	strcpy((yyval.sval), (yyvsp[0].sval)); 	}
#line 2141 "y.tab.c"
    break;

  case 83: /* primary_expression: INTEGER_LITERAL  */
#line 708 "icg.y"
                                        {	strcpy((yyval.sval), (yyvsp[0].sval)); 	}
#line 2147 "y.tab.c"
    break;

  case 84: /* primary_expression: FLOAT_LITERAL  */
#line 709 "icg.y"
                                        {	strcpy((yyval.sval), (yyvsp[0].sval)); 	}
#line 2153 "y.tab.c"
    break;

  case 85: /* primary_expression: CHARACTER_LITERAL  */
#line 710 "icg.y"
                                        {	strcpy((yyval.sval), (yyvsp[0].sval)); 	}
#line 2159 "y.tab.c"
    break;

  case 86: /* primary_expression: '(' expression ')'  */
#line 711 "icg.y"
...
#line 2171 "y.tab.c"
  ...
  case 88: /* postfix_expression: postfix_expression INC_OP  */
#line 718 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2187 "y.tab.c"
  ...
  case 89: /* postfix_expression: postfix_expression DEC_OP  */
#line 730 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2268 "y.tab.c"
  ...
  case 96: /* unary_operator: "INC_OP"  */
#line 785 "icg.y"
                        {	unaryop = 4; }
#line 2274 "y.tab.c"
    break;

  case 97: /* unary_operator: "DEC_OP"  */
#line 786 "icg.y"
                        {	unaryop = 5; }
#line 2280 "y.tab.c"
    break;
...
#line 2286 "y.tab.c"
  ...
  case 99: /* equality_expression: equality_expression EQ_OP relational_expression  */
#line 793 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2300 "y.tab.c"
  ...
  case 100: /* equality_expression: equality_expression NE_OP relational_expression  */
#line 803 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2348 "y.tab.c"
  ...
  case 104: /* relational_expression: relational_expression LE_OP additive_expression  */
#line 838 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2362 "y.tab.c"
  ...
  case 105: /* relational_expression: relational_expression GE_OP additive_expression  */
#line 848 "icg.y"
                {
			sprintf(buffer,"t%d",tempno++);
			m = strlen(buffer);
...
#line 2382 "y.tab.c"
  ...
  case 107: /* additive_expression: additive_expression '+' multiplicative_expression  */
#line 863 "icg.y"
                {
			// printf("%s + %s\n", $1, $3 );
			sprintf(buffer,"t%d",tempno++);
...
#line 2453 "y.tab.c"
  ...
  case 115: /* function_call: declarator '(' identifier_list ')'  */
#line 928 "icg.y"
                {
			paramno++;	
...
#line 2465 "y.tab.c"
  ...
  case 116: /* function_call: declarator '(' ')'  */
#line 936 "icg.y"
                {
...
#line 2474 "y.tab.c"
  ...
  case 117: /* declarator: IDENTIFIER  */
#line 945 "icg.y"
                { 
			m = strlen((yyvsp[0].sval));
			strncpy((yyval.sval), (yyvsp[0].sval), m);	
...
#line 2484 "y.tab.c"
  ...
  case 118: /* declarator: declarator '(' parameter_list ')'  */
#line 951 "icg.y"
                {
